package com.roll_54.roll_mod_client.blocks.entity.render.model.rocket.normal;
...
public class NormalRocketModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("roll_mod", "normal_rocket"), "main");
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        // static display – no animation needed for block entity rendering
    }

    @Override
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        rocket.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }
}