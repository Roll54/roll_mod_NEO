package com.roll_54.roll_mod_client.blocks.entity.render.model.rocket.small;
...
public class SmallRocketModel<T extends Entity> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("roll_mod", "small_rocket"), "main");
