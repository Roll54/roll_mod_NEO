package com.roll_54.roll_mod_client.gui.screen;
...
public class GrowthChamberScreen extends AbstractContainerScreen<GrowthChamberMenu>  {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.parse("roll_mod:textures/gui/growth_chamber/growth_chamber_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.parse("roll_mod:textures/gui/arrow_progress.png");
