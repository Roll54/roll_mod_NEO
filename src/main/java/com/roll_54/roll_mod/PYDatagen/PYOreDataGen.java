...
public class PYOreDataGen {
    ...
    static {
        ...
        registerOreVariants("biotite", ORE_PROPERTIES, "deepslate", "moon");
        ...
        registerOreVariants("pyrope", ORE_PROPERTIES, "stone", "venus");
        registerOreVariants("apatite", ORE_PROPERTIES, "venus", "moon");
        registerOreVariants("galena", ORE_PROPERTIES, "stone", "mars");
        registerOreVariants("pyrolusite", ORE_PROPERTIES, "deepslate", "stone");
        ...
        registerOreVariants("pyrite", ORE_PROPERTIES, "stone", "mars");
        ...
        registerOreVariants("ruby", ORE_PROPERTIES, "end", "netherrack", "stone");
        registerOreVariants("redstone", ORE_PROPERTIES, "mars", "netherrack", "stone");
        registerOreVariants("saltpeter", ORE_PROPERTIES, "stone", "netherrack");
        registerOreVariants("emerald", ORE_PROPERTIES, "venus", "netherrack");
        registerOreVariants("beryllium", ORE_PROPERTIES, "deepslate", "netherrack");
        registerOreVariants("tantalite", ORE_PROPERTIES, "stone", "netherrack");
        ...
        registerOreVariants("gold", ORE_PROPERTIES, "stone", "netherrack", "deepslate");
