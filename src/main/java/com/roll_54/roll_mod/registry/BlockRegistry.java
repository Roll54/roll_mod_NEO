...
public class BlockRegistry {
    ...
    public static final DeferredBlock<Block> RESEARCH_WORKBENCH = BLOCKS.register(
            "research_workbench",
            () -> new ResearchWorkbenchBlock(BlockBehaviour.Properties.of().strength(2.0F).sound(SoundType.COPPER).noOcclusion()));

    public static final DeferredBlock<Block> TELESCOPE = BLOCKS.register(
            "telescope",
