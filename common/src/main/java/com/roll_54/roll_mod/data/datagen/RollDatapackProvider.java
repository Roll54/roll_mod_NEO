...
public class RollDatapackProvider extends DatapackBuiltinEntriesProvider {
    ...
    public RollDatapackProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
